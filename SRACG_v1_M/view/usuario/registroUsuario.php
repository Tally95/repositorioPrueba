    ...
    <div class="cajaRegistro">
        ...
        <form action="?c=registroUsuario&a=Guardar" method="post">
            ...
            <div class="entradaFila_2 ent">
                <input name="email" type="email" class="input" required placeholder="Email"style="width: 370px; margin-right: 20px;">

                
                <input type="radio" class="radio" name="sexo" value="Mujer" id="mujerR" required >
                <label for="mujerR">Mujer</label>

                <input type="radio" class="radio" name="sexo" value="Hombre" id="hombreR" required >
            ...
            <div class="entradaFila_3 ent">
                <input name="contra"type="password" class="input" required placeholder="Contraseña" style="width: 250px; margin-right: 15px;">
                <select class="input" name="pais" required="required"style="width: 250px; margin-left: 15px;">
            ...
            <div class="entradaFila_4 ent">
                <input name="comfirContra" type="password" class="input" required placeholder="Comfirmar Contraseña" style="width: 250px; margin-right: 15px;">
                <input name="tel"type="number" class="input" required placeholder="Telefono" style="width: 250px; margin-left: 15px;">
            </div> 

            <div class="entradaFila_5 ent">     
                <input type="submit" class="regisBtn" value="REGISTRARSE">
